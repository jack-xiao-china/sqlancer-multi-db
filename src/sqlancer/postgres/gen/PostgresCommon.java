...
public final class PostgresCommon {
    ...
    public static List<String> getCommonExpressionErrors() {
        ...
        errors.add("invalid input syntax for type timestamp");
        errors.add("invalid input syntax for type date");
        errors.add("invalid input syntax for type time");
        ...
        errors.add("timestamp out of range");
        // JSON/JSONB
        errors.add("invalid input syntax for type json");
        errors.add("invalid input syntax for type jsonb");
        // JSON operators and functions
        errors.add("cannot extract array element from a non-array");
        errors.add("cannot extract field from a non-object");
        errors.add("cannot call jsonb_array_length on a scalar");
        errors.add("cannot call json_array_length on a scalar");
        errors.add("cannot call jsonb_object_keys on a scalar");
        errors.add("cannot call json_object_keys on a scalar");
        errors.add("JSON path expression syntax error");
        errors.add("invalid input syntax for type jsonpath");
        errors.add("jsonb_object requires one-dimensional arrays");
        errors.add("arrays must have same number of elements");
        errors.add("null value not allowed for jsonb_object");
        errors.add("jsonb_object requires text arrays");
        // BYTEA
        errors.add("invalid input syntax for type bytea");
    ...
    private static List<String> getBitStringOperationErrors() {
        ...
        // Localized message still includes this signature.
        errors.add("bit >> bit");
