...
/**
 * PostgreSQL EET DELETE Oracle — tests DELETE by comparing row-state changes
 * between original and EET-transformed WHERE conditions.
 */
public class PostgresEETDeleteOracle
    ...
    public PostgresEETDeleteOracle(PostgresGlobalState state) {
        super(state, null);
    }
