...
public enum PostgresFunctionWithUnknownResult {
    ...
    JSON_TYPEOF("json_typeof", PostgresDataType.TEXT, PostgresDataType.JSON),
    JSONB_TYPEOF("jsonb_typeof", PostgresDataType.TEXT, PostgresDataType.JSONB),
    JSON_ARRAY_LENGTH("json_array_length", PostgresDataType.INT, PostgresDataType.JSON),
    JSONB_ARRAY_LENGTH("jsonb_array_length", PostgresDataType.INT, PostgresDataType.JSONB),
    JSON_OBJECT_KEYS("json_object_keys", PostgresDataType.TEXT, PostgresDataType.JSON),
    JSONB_OBJECT_KEYS("jsonb_object_keys", PostgresDataType.TEXT, PostgresDataType.JSONB),
    JSONB_PRETTY("jsonb_pretty", PostgresDataType.TEXT, PostgresDataType.JSONB),
    JSON_STRIP_NULLS("json_strip_nulls", PostgresDataType.JSON, PostgresDataType.JSON),
    JSONB_STRIP_NULLS("jsonb_strip_nulls", PostgresDataType.JSONB, PostgresDataType.JSONB);
