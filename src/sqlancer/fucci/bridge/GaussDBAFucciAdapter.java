 ...
 * GaussDB-A Fucci适配器。
 */
public class GaussDBAFucciAdapter implements DBMSFucciAdapter {

    @Override
    public String getDbmsType() { return "gaussdba"; }
    ...
    public boolean isDeadlockError(String errorMessage) {
        ...
        return errorMessage.contains("Deadlock") || errorMessage.contains("ORA-00060");
    }

    @Override
    public boolean isLockWaitTimeoutError(String errorMessage) {
        if (errorMessage == null) { return false; }
        return errorMessage.contains("timeout") || errorMessage.contains("ORA-04020");
    }
    ...
    @Override
    public List<String> getSupportedExpressionTypes() { return Arrays.asList("comparison", "logical", "arithmetical", "function", "type_cast", "decode"); }
}