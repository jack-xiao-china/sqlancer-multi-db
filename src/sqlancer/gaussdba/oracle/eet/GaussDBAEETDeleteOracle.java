...
/**
 * GaussDB-A EET DELETE Oracle — tests DELETE by comparing row-state changes
 * between original and EET-transformed WHERE conditions.
 */
public class GaussDBAEETDeleteOracle
    ...
    public GaussDBAEETDeleteOracle(GaussDBAGlobalState state) {
        super(state, null);
    }
    ...
    protected SQLQueryAdapter generateDML(GaussDBAGlobalState state, Object gen,
        ...
        sb.append(" WHERE ");
        sb.append(GaussDBAToStringVisitor.asString(whereCondition));
