...
public class GaussDBAOptions implements DBMSSpecificOptions<GaussDBAOracleFactory> {
    ...
    @Parameter(names = "--oracle", description = "Specifies which test oracle should be used, Options: [AGGREGATE, CERT, DISTINCT, DQE, DQP, EET, FUCCI, FUZZER, GROUP_BY, HAVING, NOREC, PQS, QUERY_PARTITIONING, TLP_WHERE, WRITE_CHECK, WRITE_CHECK_REPRODUCE]")
